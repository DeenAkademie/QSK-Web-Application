        ...
        const video: Video = {
          ...
          progress: videoData.progress
            ? {
              ...
              progress_percent: videoData.progress.progress_percent || 0, // Hinzugefügt mit Fallback
            }
            : null,
        };
...
/**
 * Markiert ein Video als abgeschlossen für den aktuellen Benutzer.
 *
...
export async function markVideoAsCompleted(
  ...
  try {
    ...
    if (!session) {
      console.error("Error marking video as completed: No active session");
      return null;
    }
    ...
    console.log("Video erfolgreich als abgeschlossen markiert:", data);
